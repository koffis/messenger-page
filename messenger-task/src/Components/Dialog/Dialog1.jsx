...
import {AddMessage1, getChakMessage1, updateMessageText} from "../../Redux/dialogs-reducer";
...
const mapStateToProps = (state) =>({
    dialog: state.dialogs.dialog1,
    newMessageText: state.dialogs.newMessageText
});

export default connect(mapStateToProps,{AddMessage1, updateMessageText, getChakMessage1})(Dialog1);